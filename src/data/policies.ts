export const policies = {
  cancellation: [
    "Trainee can cancel or reschedule 2 days before appointment date.",
    "Cancellation is not allowed.",
    "Trainee can cancel within 24 hours before appointment.",
  ],
  health: [
  ...
  equipment: [
    ...
    "Equipment is available and you can come with yours as well.",
  ],
};
